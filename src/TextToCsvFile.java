...
public class TextToCsvFile {
    ...
    private static String readFile(String path, String encType) {
        try {
    ...
    // CSV 형태로 변환합니다
    private static String convertCsv(String data, String seperator) {
        return data.replaceAll("\\" + seperator, ", ");
    }

    private static int writeFile(String path, String encType, String csvStr) {
        try {
    ...
    public static int process(String readFilePath, String writeFilePath) {
